import torch
import numpy as np
from src.ntk.core import elementwise, get_diagonal_outer_prods
...
class ABRelu:
    def __init__(self, a: float, b: float, do_stabilize: bool = False):
        self.a = a
        self.b = b
        ...
        def kernel_function(k: Kernel) -> Kernel:
            ...
            prod11, prod12, prod22 = get_diagonal_outer_prods(
                cov1, cov2, k.diagonal_batch, k.diagonal_spatial, torch.mul
            )
